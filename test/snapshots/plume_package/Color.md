...
(can-ir
		...
		(e-lambda
			...
			(e-block
				(s-let
					...
					(e-dispatch-call (method "div_by") (constraint-fn-var 651)
						(receiver
							(e-dispatch-call (method "to_frac") (constraint-fn-var 641)
								(receiver
									(e-lookup-local
										(p-assign (ident "a"))))
								(args)))
		...
		(e-lambda
			...
			(e-block
				(s-let
					...
					(e-dispatch-call (method "to_utf8") (constraint-fn-var 708)
						(receiver
							(e-lookup-local
								(p-assign (ident "str"))))
						(args)))
							...
							(if-branches
								(if-branch
									(e-if
										(if-branches
											(if-branch
												(e-dispatch-call (method "is_gte") (constraint-fn-var 726)
													(receiver
														(e-lookup-local
															(p-assign (ident "b"))))
													(args
														(e-num (value "48"))))
												(e-dispatch-call (method "is_lte") (constraint-fn-var 737)
													(receiver
														(e-lookup-local
															(p-assign (ident "b"))))
													(args
								...
								(e-if
									(if-branches
										(if-branch
											(e-if
												(if-branches
													(if-branch
														(e-dispatch-call (method "is_gte") (constraint-fn-var 759)
															(receiver
																(e-lookup-local
																	(p-assign (ident "b"))))
															(args
																(e-num (value "97"))))
														(e-dispatch-call (method "is_lte") (constraint-fn-var 770)
															(receiver
																(e-lookup-local
																	(p-assign (ident "b"))))
															(args
									...
									(if-else
										(e-if
											(if-branches
												(if-branch
													(e-dispatch-call (method "is_gte") (constraint-fn-var 791)
														(receiver
															(e-lookup-local
																(p-assign (ident "b"))))
														(args
															(e-num (value "65"))))
													(e-dispatch-call (method "is_lte") (constraint-fn-var 802)
														(receiver
															(e-lookup-local
																(p-assign (ident "b"))))
														(args
									...
									(e-block
										(s-let
											...
											(e-if
												(if-branches
													(if-branch
														(e-dispatch-call (method "is_char_in_hex_range") (constraint-fn-var 840)
															(receiver
																(e-lookup-local
																	(p-assign (ident "a"))))
															(args))
														(e-if
															(if-branches
																(if-branch
																	(e-dispatch-call (method "is_char_in_hex_range") (constraint-fn-var 844)
																		(receiver
																			(e-lookup-local
																				(p-assign (ident "b"))))
																		(args))
																	(e-if
																		(if-branches
																			(if-branch
																				(e-dispatch-call (method "is_char_in_hex_range") (constraint-fn-var 848)
																					(receiver
																						(e-lookup-local
																							(p-assign (ident "c"))))
																					(args))
																				(e-if
																					(if-branches
																						(if-branch
																							(e-dispatch-call (method "is_char_in_hex_range") (constraint-fn-var 852)
																								(receiver
																									(e-lookup-local
																										(p-assign (ident "d"))))
																								(args))
																							(e-if
																								(if-branches
																									(if-branch
																										(e-dispatch-call (method "is_char_in_hex_range") (constraint-fn-var 856)
																											(receiver
																												(e-lookup-local
																													(p-assign (ident "e"))))
																											(args))
															...
															(args
																(e-block
																	(s-let
																		...
																		(e-lookup-local
																			(p-assign (ident "str"))))
																	(e-interpolation (constraint-fn-var 921)
																		(first
	...
	(d-let
		...
		(e-lambda
			...
			(e-if
				(if-branches
					(if-branch
						(e-dispatch-call (method "is_named_color") (constraint-fn-var 1086)
							(receiver
								(e-lookup-local
									(p-assign (ident "str"))))
							(args))
								...
								(args
									(e-block
										(s-let
											...
											(e-lookup-local
												(p-assign (ident "str"))))
										(e-interpolation (constraint-fn-var 1121)
											(first
	...
	(d-let
		...
		(e-lambda
			...
			(e-block
				...
				(e-dispatch-call (method "contains") (constraint-fn-var 1170)
					(receiver
						(e-lookup-local
							(p-assign (ident "colors"))))
					(args
	...
	(s-expect
		(e-method-eq (negated "false")
			(lhs
				(e-dispatch-call (method "to_str") (constraint-fn-var 1248)
					(receiver
						(e-call (constraint-fn-var 1205)
							(e-lookup-local
								(p-assign (ident "rgb")))
							(e-num (value "124"))
							(e-num (value "56"))
	...
	(s-expect
		(e-method-eq (negated "false")
			(lhs
				(e-dispatch-call (method "to_str") (constraint-fn-var 1348)
					(receiver
						(e-call (constraint-fn-var 1291)
							(e-lookup-local
								(p-assign (ident "rgba")))
							(e-num (value "124"))
							(e-num (value "56"))
	...
	(s-expect
		(e-method-eq (negated "false")
			(lhs
				(e-dispatch-call (method "map_ok") (constraint-fn-var 1384)
					(receiver
						(e-call (constraint-fn-var 1371)
							(e-lookup-local
								(p-assign (ident "hex")))
							(e-string
