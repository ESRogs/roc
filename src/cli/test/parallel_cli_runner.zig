...
const subcommand_cases = [_]CliCase{
    ...
    // Compile-time budget: this join-heavy structural-encoding module needs
    // the ARC inserter's summary tables to compile quickly; the tightened
    // timeout guards against reintroducing per-join analysis re-walks.
