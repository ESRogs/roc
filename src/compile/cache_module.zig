...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0x05, 0x75, 0x0F, 0x98, 0xA1, 0xEB, 0x4E, 0x89, 0xED, 0xFA, 0x8E, 0x67, 0x07, 0xF8, 0x9C, 0x85,
        0x90, 0x20, 0x67, 0x81, 0x6A, 0x19, 0xB5, 0xA8, 0xB5, 0x05, 0x81, 0xE0, 0x47, 0x40, 0x1F, 0x90,
    };
