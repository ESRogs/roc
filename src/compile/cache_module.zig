...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0x6F, 0xC6, 0x50, 0xEE, 0x9D, 0x97, 0x7C, 0xBC, 0x49, 0xF0, 0xE3, 0xEB, 0x76, 0x1D, 0x17, 0x90,
        0xFC, 0xB5, 0x30, 0x19, 0x9D, 0xC1, 0xD9, 0x5F, 0xB3, 0x7F, 0xE9, 0x36, 0xD4, 0x99, 0xFA, 0xB9,
    };
