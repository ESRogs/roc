...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0xF8, 0x04, 0x07, 0x73, 0x81, 0xE1, 0xC5, 0x0E, 0xD5, 0x62, 0x1A, 0xA0, 0xD3, 0xBE, 0x84, 0x30,
        0xEB, 0x60, 0xB0, 0xF4, 0x35, 0xB6, 0x01, 0xB4, 0xB2, 0xB3, 0x1B, 0x03, 0xD3, 0xA7, 0xC2, 0xEC,
    };
