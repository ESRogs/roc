...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0xC7, 0x30, 0x9A, 0x77, 0x4A, 0xB9, 0xCC, 0xD6, 0xEC, 0xB2, 0xF7, 0xC9, 0x62, 0x39, 0xDB, 0xD6,
        0xEC, 0x21, 0xE2, 0xD5, 0x88, 0x47, 0x6B, 0x05, 0x47, 0xE0, 0x50, 0x10, 0x47, 0x34, 0x17, 0x17,
    };
