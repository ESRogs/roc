...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0x4D, 0x77, 0x8B, 0x31, 0xD4, 0x76, 0xAB, 0x9B, 0xBA, 0xA4, 0x11, 0x2E, 0x1B, 0x8A, 0xEE, 0x34,
        0x72, 0xC5, 0x89, 0x3E, 0xBA, 0x0B, 0x85, 0x22, 0xDB, 0x4A, 0xFA, 0xCB, 0xF0, 0xE8, 0x16, 0x27,
    };
