...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0x54, 0xFF, 0xA8, 0x8D, 0xE2, 0xD6, 0x6F, 0xF4, 0x92, 0x81, 0x59, 0x08, 0xF1, 0xE7, 0xFB, 0x7A,
        0x11, 0xAB, 0x57, 0xBF, 0xB8, 0x8D, 0x52, 0x45, 0xD9, 0x8D, 0xC8, 0xFF, 0x9D, 0x2B, 0x26, 0x75,
    };
