...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0x39, 0xB2, 0xCE, 0x59, 0x37, 0x59, 0xD6, 0xAC, 0x93, 0xC7, 0x0C, 0x9F, 0xA6, 0x4F, 0xBB, 0xB1,
        0xC3, 0xDF, 0x6A, 0xA1, 0xF8, 0xBC, 0x30, 0x6D, 0x2D, 0x8C, 0x7C, 0xE0, 0xCD, 0x9F, 0x9B, 0x81,
    };
