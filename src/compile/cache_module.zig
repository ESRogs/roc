...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0x05, 0x44, 0x31, 0x69, 0x64, 0x62, 0x1D, 0x95, 0xF2, 0x2C, 0x7A, 0xB7, 0x4A, 0xC8, 0x01, 0xC4,
        0xCD, 0x9C, 0xE1, 0xE1, 0x3B, 0x3F, 0xC1, 0x56, 0x24, 0xC6, 0xFB, 0xE1, 0xA8, 0xF3, 0xD8, 0x52,
    };
