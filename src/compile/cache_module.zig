...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0x50, 0x7C, 0x3A, 0x9E, 0x7C, 0x7F, 0x6D, 0x3A, 0x92, 0x74, 0xF4, 0x69, 0x1B, 0xD2, 0x5B, 0x23,
        0xDE, 0x49, 0x74, 0xAF, 0xE3, 0xEF, 0x93, 0xE2, 0x3B, 0xDC, 0xB8, 0x10, 0xBA, 0xEE, 0x41, 0x54,
    };
