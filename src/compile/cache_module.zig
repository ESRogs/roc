...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0x8C, 0xA1, 0x8C, 0x2B, 0x83, 0x57, 0xD5, 0x40, 0x3D, 0x16, 0xAD, 0xEE, 0x80, 0x99, 0xCA, 0xC6,
        0x34, 0x7D, 0xCC, 0x09, 0x56, 0x9E, 0xC3, 0x39, 0x6A, 0x8C, 0xA5, 0x89, 0x41, 0x33, 0x7C, 0x64,
    };
