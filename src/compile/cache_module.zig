...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0xDC, 0x0A, 0x82, 0x84, 0x8C, 0xA4, 0x2C, 0xE8, 0x5F, 0xB5, 0x19, 0x54, 0x7C, 0x01, 0x56, 0x1A,
        0x94, 0xC2, 0x03, 0x55, 0x17, 0x23, 0x1C, 0x8C, 0xA2, 0xD5, 0x76, 0x4C, 0xFC, 0xBD, 0x5A, 0xBE,
    };
