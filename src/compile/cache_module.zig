...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0x9C, 0x56, 0x5C, 0x55, 0x33, 0xD3, 0x05, 0xE9, 0x25, 0x25, 0xB2, 0xF7, 0x98, 0x24, 0x9A, 0x67,
        0xEB, 0x01, 0xF0, 0xC5, 0x40, 0xBC, 0xD9, 0x99, 0xDE, 0x7F, 0x82, 0xEF, 0xC0, 0xFC, 0x24, 0x88,
    };
