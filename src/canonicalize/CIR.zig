...
pub const builtin_type_specs = [_]BuiltinTypeSpec{
    ...
    .{ .display_name = "DecParts", .qualified_name = "Builtin.Encoding.Json.DecParts", .type_field = "dec_parts_type", .ident_field = "dec_parts_ident", .lookup = .{ .qualified = "Builtin.Encoding.Json.DecParts" }, .auto_import = false },
