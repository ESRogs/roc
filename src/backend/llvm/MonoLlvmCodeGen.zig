...
pub const MonoLlvmCodeGen = struct {
    ...
    fn emitListLiteral(self: *MonoLlvmCodeGen, target: LocalId, elems: LocalSpan) Error!void {
        ...
        try self.callBuiltinVoid(
            builtinSymbol(.list_with_capacity),
    ...
    fn emitLowLevel(self: *MonoLlvmCodeGen, target: LocalId, op: lir.LowLevel, args: LocalSpan, unique_args: u64, interchangeable: layout.WidthValues(bool)) Error!void {
        ...
        switch (op) {
            ...
            .num_sin => try self.emitNumericUnaryMath(target, GuardedList.at(arg_locals, 0), builtinSymbol(.float_sin), builtinSymbol(.dec_sin)),
            .num_cos => try self.emitNumericUnaryMath(target, GuardedList.at(arg_locals, 0), builtinSymbol(.float_cos), builtinSymbol(.dec_cos)),
            .num_tan => try self.emitNumericUnaryMath(target, GuardedList.at(arg_locals, 0), builtinSymbol(.float_tan), builtinSymbol(.dec_tan)),
            .num_asin => try self.emitNumericUnaryMath(target, GuardedList.at(arg_locals, 0), builtinSymbol(.float_asin), builtinSymbol(.dec_asin)),
            .num_acos => try self.emitNumericUnaryMath(target, GuardedList.at(arg_locals, 0), builtinSymbol(.float_acos), builtinSymbol(.dec_acos)),
            .num_atan => try self.emitNumericUnaryMath(target, GuardedList.at(arg_locals, 0), builtinSymbol(.float_atan), builtinSymbol(.dec_atan)),
            ...
            .str_concat => try self.emitStrRetBuiltin(target, builtinSymbol(.str_concat), arg_locals, unique_args),
            .str_trim => try self.emitStrUnaryRetBuiltin(target, builtinSymbol(.str_trim), GuardedList.at(arg_locals, 0), unique_args),
            .str_trim_start => try self.emitStrUnaryRetBuiltin(target, builtinSymbol(.str_trim_start), GuardedList.at(arg_locals, 0), unique_args),
            .str_trim_end => try self.emitStrUnaryRetBuiltin(target, builtinSymbol(.str_trim_end), GuardedList.at(arg_locals, 0), unique_args),
            .str_with_ascii_lowercased => try self.emitStrUnaryRetBuiltin(target, builtinSymbol(.str_with_ascii_lowercased), GuardedList.at(arg_locals, 0), unique_args),
            .str_with_ascii_uppercased => try self.emitStrUnaryRetBuiltin(target, builtinSymbol(.str_with_ascii_uppercased), GuardedList.at(arg_locals, 0), unique_args),
            ...
            .str_split_on => try self.emitStrRetBuiltin(target, builtinSymbol(.str_split), arg_locals, null),
            ...
            .str_release_excess_capacity => try self.emitStrUnaryRetBuiltin(target, builtinSymbol(.str_release_excess_capacity), GuardedList.at(arg_locals, 0), unique_args),
            ...
            .str_inspect => try self.emitStrUnaryRetBuiltin(target, builtinSymbol(.str_escape_and_quote), GuardedList.at(arg_locals, 0), null),
            .dict_pseudo_seed,
            .hasher_finish,
            .hasher_write_bool,
            .hasher_write_u8,
    ...
    fn emitHasherLowLevel(self: *MonoLlvmCodeGen, target: LocalId, op: lir.LowLevel, args: anytype) Error!void {
        ...
        const result = switch (op) {
            .dict_pseudo_seed => blk: {
                ...
                break :blk try self.callBuiltin(builtinSymbol(.dict_pseudo_seed), .i64, &.{}, &.{});
            },
            .hasher_finish => blk: {
                if (args.len != 1) return error.CompilationFailed;
                const seed = try self.loadHasherState(GuardedList.at(args, 0));
                break :blk try self.callBuiltin(builtinSymbol(.hasher_finish), .i64, &.{.i64}, &.{seed});
            },
            .hasher_write_bool,
            .hasher_write_u8,
            .hasher_write_u16,
            ...
            => blk: {
                ...
                break :blk try self.callBuiltin(
                    builtinSymbol(.hasher_write_u64),
                    .i64,
                    &.{ .i64, .i8, .i64, .i8 },
                    &.{
                        seed,
            ...
            .hasher_write_f32 => blk: {
                ...
                break :blk try self.callBuiltin(builtinSymbol(.hasher_write_f32_bits), .i64, &.{ .i64, .i64 }, &.{ seed, bits64 });
            },
            .hasher_write_f64 => blk: {
                ...
                break :blk try self.callBuiltin(builtinSymbol(.hasher_write_f64_bits), .i64, &.{ .i64, .i64 }, &.{ seed, bits });
            },
            .hasher_write_u128,
            .hasher_write_i128,
            .hasher_write_dec,
            => blk: {
                ...
                break :blk try self.callBuiltin(
                    builtinSymbol(.hasher_write_u128),
                    .i64,
                    &.{ .i64, .i8, .i64, .i64 },
                    &.{
                        seed,
            ...
            .hasher_write_bytes => blk: {
                ...
                break :blk try self.callBuiltin(
                    builtinSymbol(.hasher_write_bytes),
                    .i64,
            ...
            .hasher_write_str => blk: {
                ...
                break :blk try self.callBuiltin(
                    builtinSymbol(.hasher_write_str),
                    .i64,
    ...
    fn emitCryptoLowLevel(self: *MonoLlvmCodeGen, target: LocalId, op: lir.LowLevel, args: anytype) Error!void {
        ...
        const info: CryptoInfo = switch (op) {
            .crypto_sha256_hash_bytes => .{ .name = builtinSymbol(.crypto_sha256_hash_bytes), .arity = Arity.one },
            .crypto_sha256_hasher_empty => .{ .name = builtinSymbol(.crypto_sha256_hasher_empty), .arity = Arity.zero },
            .crypto_sha256_hasher_write => .{ .name = builtinSymbol(.crypto_sha256_hasher_write), .arity = Arity.two },
            .crypto_sha256_hasher_finish => .{ .name = builtinSymbol(.crypto_sha256_hasher_finish), .arity = Arity.one },
            .crypto_blake3_hash_bytes => .{ .name = builtinSymbol(.crypto_blake3_hash_bytes), .arity = Arity.one },
            .crypto_blake3_hasher_empty => .{ .name = builtinSymbol(.crypto_blake3_hasher_empty), .arity = Arity.zero },
            .crypto_blake3_hasher_write => .{ .name = builtinSymbol(.crypto_blake3_hasher_write), .arity = Arity.two },
            .crypto_blake3_hasher_finish => .{ .name = builtinSymbol(.crypto_blake3_hasher_finish), .arity = Arity.one },
            else => return error.UnsupportedLowLevel,
        };
    ...
    fn callCheckedI128MulBuiltin(
        ...
        const overflowed_i32 = try self.callBuiltin(
            if (unsigned) builtinSymbol(.num_mul_with_overflow_u128) else builtinSymbol(.num_mul_with_overflow_i128),
            .i32,
    ...
    fn emitDecBinary(self: *MonoLlvmCodeGen, target: LocalId, op: lir.LowLevel, args: anytype) Error!void {
        ...
        const result = switch (op) {
            ...
            .num_times => try self.callDecBinaryBuiltin(builtinSymbol(.dec_mul_saturated), lhs, rhs, false),
            .num_div_by => try self.callDecBinaryBuiltin(builtinSymbol(.dec_div), lhs, rhs, true),
            .num_div_trunc_by => try self.callDecBinaryBuiltin(builtinSymbol(.dec_div_trunc), lhs, rhs, true),
            .num_rem_by, .num_mod_by => blk: {
                const quotient = try self.callDecBinaryBuiltin(builtinSymbol(.dec_div_trunc), lhs, rhs, true);
                const product = try self.callDecBinaryBuiltin(builtinSymbol(.dec_mul_saturated), quotient, rhs, false);
    ...
    fn emitIntTryConversion(self: *MonoLlvmCodeGen, target: LocalId, arg: LocalId) Error!void {
        ...
        const func_name = if (source_layout.isSigned()) builtinSymbol(.i128_try_convert) else builtinSymbol(.u128_try_convert);
        try self.callBuiltinVoid(
            func_name,
    ...
    fn emitStrFindFirst(self: *MonoLlvmCodeGen, target: LocalId, args: anytype) Error!void {
        ...
        try call_args.append(self.allocator, try self.ptrType(), self.rocOps());
        try self.callBuiltinVoid(builtinSymbol(.str_find_first), call_args.types.items, call_args.values.items);
    }
    ...
    fn emitStrDropPrefixCaselessAscii(self: *MonoLlvmCodeGen, target: LocalId, args: anytype) Error!void {
        ...
        try call_args.append(self.allocator, try self.ptrType(), layout_ptr);
        try call_args.append(self.allocator, try self.ptrType(), self.rocOps());
        try self.callBuiltinVoid(builtinSymbol(.str_drop_prefix_caseless_ascii), call_args.types.items, call_args.values.items);
    }
    ...
    fn emitStrJoinWith(self: *MonoLlvmCodeGen, target: LocalId, args: anytype) Error!void {
        ...
        try call_args.append(self.allocator, try self.ptrType(), self.rocOps());
        try self.callBuiltinVoid(builtinSymbol(.str_join_with), call_args.types.items, call_args.values.items);
    }
    ...
    fn emitStrRepeat(self: *MonoLlvmCodeGen, target: LocalId, args: anytype) Error!void {
        ...
        try call_args.append(self.allocator, try self.ptrType(), self.rocOps());
        try self.callBuiltinVoid(builtinSymbol(.str_repeat), call_args.types.items, call_args.values.items);
    }
    ...
    fn emitStrWithCapacity(self: *MonoLlvmCodeGen, target: LocalId, capacity: LocalId) Error!void {
        ...
        try self.callBuiltinVoid(builtinSymbol(.str_with_capacity), &.{ try self.ptrType(), .i64, try self.ptrType() }, &.{ self.slot(target).ptr, cap, self.rocOps() });
    }
    ...
    fn emitStrReserve(self: *MonoLlvmCodeGen, target: LocalId, args: anytype, unique_args: u64) Error!void {
        ...
        try call_args.append(self.allocator, try self.ptrType(), self.rocOps());
        try self.callBuiltinVoid(builtinSymbol(.str_reserve), call_args.types.items, call_args.values.items);
    }
    ...
    fn emitStrToUtf8(self: *MonoLlvmCodeGen, target: LocalId, arg: LocalId) Error!void {
        ...
        try call_args.prepend(self.allocator, try self.ptrType(), self.slot(target).ptr);
        try call_args.append(self.allocator, try self.ptrType(), self.rocOps());
        try self.callBuiltinVoid(builtinSymbol(.str_to_utf8), call_args.types.items, call_args.values.items);
    }
    ...
    fn emitStrFromUtf8Lossy(self: *MonoLlvmCodeGen, target: LocalId, arg: LocalId) Error!void {
        ...
        try call_args.prepend(self.allocator, try self.ptrType(), self.slot(target).ptr);
        try call_args.append(self.allocator, try self.ptrType(), self.rocOps());
        try self.callBuiltinVoid(builtinSymbol(.str_from_utf8_lossy), call_args.types.items, call_args.values.items);
    }
    ...
    fn emitStrFromUtf8(self: *MonoLlvmCodeGen, target: LocalId, arg: LocalId) Error!void {
        ...
        try call_args.append(self.allocator, try self.ptrType(), layout_ptr);
        try call_args.append(self.allocator, try self.ptrType(), self.rocOps());
        try self.callBuiltinVoid(builtinSymbol(.str_from_utf8_result), call_args.types.items, call_args.values.items);
    }
    ...
    fn emitIntFromStr(self: *MonoLlvmCodeGen, target: LocalId, arg: LocalId, width: u8, signed: bool) Error!void {
        ...
        try self.callBuiltinVoid(builtinSymbol(.int_from_str), call_args.types.items, call_args.values.items);
    }
    ...
    fn emitDecFromStr(self: *MonoLlvmCodeGen, target: LocalId, arg: LocalId) Error!void {
        ...
        try call_args.prepend(self.allocator, try self.ptrType(), allocated.ptr);
        try call_args.append(self.allocator, .i32, builder.intValue(.i32, disc_offset) catch return error.OutOfMemory);
        try self.callBuiltinVoid(builtinSymbol(.dec_from_str), call_args.types.items, call_args.values.items);
    }
    ...
    fn emitFloatFromStr(self: *MonoLlvmCodeGen, target: LocalId, arg: LocalId, width: u8) Error!void {
        ...
        try call_args.append(self.allocator, .i8, builder.intValue(.i8, width) catch return error.OutOfMemory);
        try call_args.append(self.allocator, .i32, builder.intValue(.i32, disc_offset) catch return error.OutOfMemory);
        try self.callBuiltinVoid(builtinSymbol(.float_from_str), call_args.types.items, call_args.values.items);
    }
    ...
    fn emitIntToStr(self: *MonoLlvmCodeGen, target: LocalId, arg: LocalId) Error!void {
        ...
        try self.callBuiltinVoid(builtinSymbol(.int_to_str), &.{ try self.ptrType(), .i64, .i64, .i8, .i1, try self.ptrType() }, &.{
            self.slot(target).ptr,
            lo,
            hi64,
    ...
    fn emitFloatToStr(self: *MonoLlvmCodeGen, target: LocalId, arg: LocalId) Error!void {
        ...
        try self.callBuiltinVoid(builtinSymbol(.float_to_str), &.{ try self.ptrType(), .i64, .i1, try self.ptrType() }, &.{
            self.slot(target).ptr,
            bits,
    ...
    fn emitNumericSqrt(self: *MonoLlvmCodeGen, target: LocalId, arg: LocalId) Error!void {
        if (self.localLayout(target) == .dec) {
            const value = try self.loadScalar(self.slot(arg).ptr, .dec);
            const result = try self.callDecUnaryBuiltin(builtinSymbol(.dec_sqrt), value);
            try self.storeScalar(self.slot(target).ptr, .dec, result);
            return;
        }
    ...
    fn emitDecPow(self: *MonoLlvmCodeGen, target: LocalId, args: anytype) Error!void {
        const lhs = try self.loadScalar(self.slot(GuardedList.at(args, 0)).ptr, .dec);
        const rhs = try self.loadScalar(self.slot(GuardedList.at(args, 1)).ptr, .dec);
        const result = try self.callDecBinaryBuiltin(builtinSymbol(.dec_pow), lhs, rhs, true);
        try self.storeScalar(self.slot(target).ptr, .dec, result);
    }
    ...
    fn emitDecToStr(self: *MonoLlvmCodeGen, target: LocalId, arg: LocalId) Error!void {
        ...
        const hi = (self.wip orelse return error.CompilationFailed).bin(.lshr, value, builder.intValue(.i128, 64) catch return error.OutOfMemory, "") catch return error.OutOfMemory;
        const hi64 = try self.coerceScalar(hi, .i64, false);
        try self.callBuiltinVoid(builtinSymbol(.dec_to_str), &.{ try self.ptrType(), .i64, .i64, try self.ptrType() }, &.{ self.slot(target).ptr, lo, hi64, self.rocOps() });
    }
    ...
    fn emitListMapCanReuse(self: *MonoLlvmCodeGen, target: LocalId, args: anytype, interchangeable: layout.WidthValues(bool)) Error!void {
        ...
        defer call_args.deinit(self.allocator);
        try call_args.append(self.allocator, try self.ptrType(), self.rocOps());
        const result = try self.callBuiltin(builtinSymbol(.list_map_can_reuse), .i8, call_args.types.items, call_args.values.items);
        try self.storeIntToLayout(self.slot(target).ptr, result, self.localLayout(target));
    }
    ...
    fn emitListWithCapacity(self: *MonoLlvmCodeGen, target: LocalId, args: anytype) Error!void {
        ...
        try self.callBuiltinVoid(builtinSymbol(.list_with_capacity), &.{ try self.ptrType(), .i64, .i32, self.ptrSizedIntType(), .i1, try self.ptrType() }, &.{
            self.slot(target).ptr,
            cap,
            builder.intValue(.i32, abi.elem_alignment) catch return error.OutOfMemory,
            builder.intValue(self.ptrSizedIntType(), abi.elem_size) catch return error.OutOfMemory,
    ...
    fn emitListAppendUnsafe(self: *MonoLlvmCodeGen, target: LocalId, args: anytype) Error!void {
        ...
        try call_args.append(self.allocator, try self.ptrType(), self.rocOps());
        try self.callBuiltinVoid(builtinSymbol(.list_append_unsafe), call_args.types.items, call_args.values.items);
    }
    ...
    fn emitListConcat(self: *MonoLlvmCodeGen, target: LocalId, args: anytype, unique_args: u64) Error!void {
        ...
        try call_args.append(self.allocator, try self.ptrType(), self.rocOps());
        try self.callBuiltinVoid(builtinSymbol(.list_concat), call_args.types.items, call_args.values.items);
    }
    ...
    fn emitListPrepend(self: *MonoLlvmCodeGen, target: LocalId, args: anytype, unique_args: u64) Error!void {
        ...
        try self.appendUpdateModeArg(&call_args, unique_args);
        try call_args.append(self.allocator, try self.ptrType(), self.rocOps());
        try self.callBuiltinVoid(builtinSymbol(.list_prepend), call_args.types.items, call_args.values.items);
    }
    ...
    fn emitListSublist(self: *MonoLlvmCodeGen, target: LocalId, op: lir.LowLevel, args: anytype, unique_args: u64) Error!void {
        ...
        try self.appendUpdateModeArg(&call_args, unique_args);
        try call_args.append(self.allocator, try self.ptrType(), self.rocOps());
        try self.callBuiltinVoid(builtinSymbol(.list_sublist), call_args.types.items, call_args.values.items);
    }
    ...
    fn emitListDropAt(self: *MonoLlvmCodeGen, target: LocalId, args: anytype, unique_args: u64) Error!void {
        ...
        try self.appendUpdateModeArg(&call_args, unique_args);
        try call_args.append(self.allocator, try self.ptrType(), self.rocOps());
        try self.callBuiltinVoid(builtinSymbol(.list_drop_at), call_args.types.items, call_args.values.items);
    }
    ...
    fn emitListSwap(self: *MonoLlvmCodeGen, target: LocalId, args: anytype, unique_args: u64) Error!void {
        ...
        try self.appendUpdateModeArg(&call_args, unique_args);
        try call_args.append(self.allocator, try self.ptrType(), self.rocOps());
        try self.callBuiltinVoid(builtinSymbol(.list_swap), call_args.types.items, call_args.values.items);
    }
    ...
    fn emitListSet(self: *MonoLlvmCodeGen, target: LocalId, args: anytype, unique_args: u64) Error!void {
        ...
        try self.appendUpdateModeArg(&call_args, unique_args);
        try call_args.append(self.allocator, try self.ptrType(), self.rocOps());
        try self.callBuiltinVoid(builtinSymbol(.list_replace), call_args.types.items, call_args.values.items);
    }
    ...
    fn emitListReserve(self: *MonoLlvmCodeGen, target: LocalId, args: anytype, unique_args: u64) Error!void {
        ...
        try self.appendUpdateModeArg(&call_args, unique_args);
        try call_args.append(self.allocator, try self.ptrType(), self.rocOps());
        try self.callBuiltinVoid(builtinSymbol(.list_reserve), call_args.types.items, call_args.values.items);
    }
    ...
    fn emitListReleaseExcess(self: *MonoLlvmCodeGen, target: LocalId, args: anytype, unique_args: u64) Error!void {
        ...
        try self.appendUpdateModeArg(&call_args, unique_args);
        try call_args.append(self.allocator, try self.ptrType(), self.rocOps());
        try self.callBuiltinVoid(builtinSymbol(.list_release_excess_capacity), call_args.types.items, call_args.values.items);
    }
        ...
        switch (layout_val.tag) {
            .scalar => switch (layout_val.getScalar().tag) {
                .str => {
                    ...
                    out.* = try self.callBuiltin(builtinSymbol(.str_equal), .i1, &.{ try self.ptrType(), self.ptrSizedIntType(), self.ptrSizedIntType(), try self.ptrType(), self.ptrSizedIntType(), self.ptrSizedIntType() }, &.{ lhs_fields[0], lhs_fields[1], lhs_fields[2], rhs_fields[0], rhs_fields[1], rhs_fields[2] });
                },
                else => {
    ...
    fn emitRcHelperBody(self: *MonoLlvmCodeGen, helper_key: layout.RcHelperKey, atomicity: RcAtomicity, value_ptr: LlvmBuilder.Value, count_value: ?LlvmBuilder.Value) Error!void {
        switch (self.layouts().rcHelperPlan(helper_key)) {
            ...
            .str_decref => try self.emitRcHelperStrDrop(value_ptr, switch (atomicity) {
                .atomic => builtinSymbol(.decref_data_ptr),
                .single_thread => builtinSymbol(.decref_data_ptr_single_thread),
            }),
            .str_free => try self.emitRcHelperStrDrop(value_ptr, builtinSymbol(.free_data_ptr)),
            ...
            .list_decref => |list_plan| try self.emitRcHelperListDrop(list_plan, value_ptr, atomicity, switch (atomicity) {
                .atomic => builtinSymbol(.list_decref_with),
                .single_thread => builtinSymbol(.list_decref_with_single_thread),
            }),
            .list_free => |list_plan| try self.emitRcHelperListDrop(list_plan, value_ptr, atomicity, builtinSymbol(.list_free_with)),
            ...
            .box_decref => |box_plan| try self.emitRcHelperBoxDrop(box_plan, value_ptr, atomicity, switch (atomicity) {
                .atomic => builtinSymbol(.box_decref_with),
                .single_thread => builtinSymbol(.box_decref_with_single_thread),
            }),
            .box_free => |box_plan| try self.emitRcHelperBoxDrop(box_plan, value_ptr, atomicity, builtinSymbol(.box_free_with)),
            ...
            .erased_callable_decref => try self.emitRcHelperErasedCallableDrop(value_ptr, switch (atomicity) {
                .atomic => builtinSymbol(.erased_callable_decref),
                .single_thread => builtinSymbol(.erased_callable_decref_single_thread),
            }),
            .erased_callable_free => try self.emitRcHelperErasedCallableDrop(value_ptr, builtinSymbol(.erased_callable_free)),
    ...
    fn increfDataPtrBuiltinName(atomicity: RcAtomicity) []const u8 {
        return switch (atomicity) {
            .atomic => builtinSymbol(.incref_data_ptr),
            .single_thread => builtinSymbol(.incref_data_ptr_single_thread),
        };
    }
    ...
    fn emitRcHelperListIncref(self: *MonoLlvmCodeGen, list_plan: layout.RcListPlan, value_ptr: LlvmBuilder.Value, count_value: LlvmBuilder.Value, atomicity: RcAtomicity) Error!void {
        ...
        try self.callBuiltinVoid(
            switch (atomicity) {
                .atomic => builtinSymbol(.list_incref),
                .single_thread => builtinSymbol(.list_incref_single_thread),
            },
    ...
    fn emitRcHelperErasedCallableIncref(self: *MonoLlvmCodeGen, value_ptr: LlvmBuilder.Value, count_value: LlvmBuilder.Value, atomicity: RcAtomicity) Error!void {
        ...
        try self.callBuiltinVoid(
            switch (atomicity) {
                .atomic => builtinSymbol(.erased_callable_incref),
                .single_thread => builtinSymbol(.incref_data_ptr_single_thread),
            },
            &.{ try self.ptrType(), self.ptrSizedIntType(), try self.ptrType() },
            &.{ payload_ptr, count_value, self.rocOps() },
